...
public class SearchAction extends BaseAction{
	...
	public String execute() throws Exception {
		...
		String searchString =(request.getParameter("word"));
		
	List<Dessert> desserts =dessertService.getDessertByName(searchString);
		
	//	List<Dessert> desserts=dessertService.getDesserts();
			System.out.println( desserts.size()+"asgfetrhe");
